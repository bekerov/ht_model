...
def main():
    ...
    #task_states = task_params[ts.TaskParams.task_states]
    #possible_task_start_states = task_params[ts.TaskParams.possible_task_start_states]
    #task_state_action_map = task_params[ts.TaskParams.task_state_action_map]
    #feature_matrix = task_params[ts.TaskParams.feature_matrix]
    #print "Start states:"
    #print possible_task_start_states
    #print "State space: ", task_states.shape, task_states.size
    #print "Action space: ", task_state_action_map.shape, task_state_action_map.size
