...
def compute_uniform_state_action_distribution_dict():
    """Function to compute a uniform distribution for actions for each task state
    """
...
def simulate_random_state_action_distribution():
    ...
    """
    r1_state_action_distribution_dict = compute_uniform_state_action_distribution_dict()
    r2_state_action_distribution_dict = compute_uniform_state_action_distribution_dict()
